...
def main():
    ...
    """
    user_first_name = input("Enter your name:")  # Description: Prompt the user to enter their first name.
    result = valid_first_name(user_first_name)  # Description: Validate the entered first name.
